...
def get_args_parser():
    ...
    parser.add_argument("--dataset", type=str, default="audioset", help="dataset", choices=["audioset", "esc50", "speechcommands", "iflytek"])
...
def main(args):
    ...
    if not args.audio_exp:
        ...
        target_length = {'audioset':1024, 'esc50':512, 'speechcommands':128, 'iflytek':1024}
        multilabel_dataset = {'audioset': True, 'esc50': False, 'k400': False, 'speechcommands': True, 'iflytek': False}
    ...
    if args.audio_exp:
        model = models_mae.__dict__[args.model](norm_pix_loss=args.norm_pix_loss, 	
                                            ...
                                            img_size=(target_length[args.dataset],256),	
    ...
    if args.resume:
        checkpoint = torch.load(args.resume, map_location='cpu')
        print("Load optimizer from: %s" % args.resume)
        # breakpoint()
