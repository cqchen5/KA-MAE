...
def parse_args():
    ...
    parser.add_argument("--use_volta16", action='store_true', help="Request 16G V100 GPUs")
...
def get_shared_folder() -> Path:
    ...
    checkpoint_path = os.path.join(current_dir, "checkpoint_finetune/experiments")
...
def main():
    ...
    kwargs = {}
    if args.use_volta16:
        kwargs['slurm_constraint'] =  'a100-48gb' #'volta16gb'
    if args.comment:
