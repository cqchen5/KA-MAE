...
_C.Vesper.encoder_embed_dim = 768   #1024
_C.Vesper.ffn_embed_dim = 3072  #40966
_C.Vesper.num_heads = 12    #16
_C.Vesper.activation = 'gelu'
_C.Vesper.dropout = 0.1
_C.Vesper.bias = True
_C.Vesper.normalize = False #True
_C.Vesper.normalize_before = False #True
...
_C.Vesper.path_to_wavlm = ['/train20/sppro/permanent/cqchen5/model/WavLM_Base/WavLM-Base.pt', '/train20/sppro/permanent/cqchen5/model/WavLM_Large/pytorch_model.bin']
...
# feature encoder
_C.Vesper.extractor_mode = 'default'    #'layer_norm'   # 'default' / 'layer_norm'
